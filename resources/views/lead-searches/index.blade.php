<x-app-layout>
    ...
    <x-slot name="actions">
        <a href="{{ route('lead-searches.create') }}" class="bg-brand-blue text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-blue-600 transition-all flex items-center shadow-lg shadow-blue-500/20 active:scale-95">
    ...
    <div class="space-y-6" x-data="leadHistoryManager()">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-4">
                ...
                <div class="flex flex-wrap items-center gap-3 w-full lg:w-auto">
                    ...
                    <div class="flex-1 lg:w-48 min-w-[160px]">
                        <select x-model="filters.user_id" @change="fetchHistory()" class="w-full bg-slate-50 border-slate-200 rounded-xl text-sm focus:ring-brand-blue focus:border-brand-blue py-2">
                    ...
                    {{-- Reset Button --}}
                    <button @click="resetFilters()" class="text-xs font-bold text-slate-400 hover:text-brand-blue transition-colors flex items-center px-2 py-2 shrink-0">
        ...
        {{-- Results Container --}}
        <div id="history-container" class="transition-opacity duration-200" :class="loading ? 'opacity-50' : 'opacity-100'">
